  ...
  return (
    <div name="home" className="w-full h-screen bg-[#012F44]">
      ...
      <div className="max-w-[1000px] h-full mx-auto px-6 flex flex-col justify-center">
        <p className=" text-[#F28749]">Hi, my name is</p>
        <h1 className="text-4xl sm:text-5xl font-bold text-[#FF9D0A]">Josh Sendzul</h1>
        <h2 className="text-4xl sm:text-6xl font-bold text-slate-300">I'm a Full Stack Developer</h2>
        <p className="text-[#DEEFE7] py-4 max-w-[700px]"></p>
        <div className="pl-8">
